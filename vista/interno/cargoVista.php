...
<div class="modal fade" id="Agregar" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header alert alert-success">
                <h3 class="modal-title"> <strong>Registrar Cargo</strong> </h3>
                <button type="button" class="btn text-white" data-bs-dismiss="modal" aria-label="Close"><i class="bi bi-x-lg"></i></button>
            </div>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="sede" class="col-sm-6 col-form-label"><strong>Número de Cargo</strong></label>
                                    <div class="input-group">
                                        <button type="button" class="iconos btn btn-secondary" data-bs-trigger="hover focus" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="top" data-bs-content="Introduzca el número de cargo."><i class="bi bi-person-fill"></i></button>
                                        <input class="form-control" type="text" id="num_cargo" />
                                    </div>
