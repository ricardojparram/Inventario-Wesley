  ...
  <main class="main" id="main">
    ...
    <div class="modal fade" id="agregar" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header alert alert-success">
            <h3 class="modal-title"> <strong>Registrar Donacion por Personal</strong> </h3>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
                ...
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      <label for="inputText" class="col-sm-3 col-form-label"><strong>Personal</strong></label>
                      <div class="input-group">
                        ...
                        <select class="form-control select2" id="cedula">
                          <option value="0" selected disabled>Personal</option>
                        </select>
                      </div>
...
<script src="assets/js/donativoPersonal.js"></script>
