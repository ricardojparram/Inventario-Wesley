...
<head>
    ...
    <title>Donativos Pacientes</title>
    <?php $VarComp->header(); ?>
...
<!-- ======= Sidebar ======= -->
  ...
  <main class="main" id="main">
    <div class="pagetitle">
      <h1>Donativos Pacientes</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item">Donaciones para los Pacientes</li>
        </ol>
      </nav>
  ...
  <div class="card">
          ...
          <div class="modal fade" id="agregar" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                <div class="modal-header alert alert-success">
                  <h3 class="modal-title"> <strong>Registrar Donacion por Paciente</strong> </h3>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                      ...
                      <div class="container-fluid">
                        <div class="row">
                          ...
                          <div class="form-group col-md-6">                          
                            <label for="inputText" class="col-sm-3 col-form-label"><strong>Paciente</strong></label>
...
<script src="assets/js/donativoPaciente.js"></script>
