...
<!-- ======= Sidebar ======= -->
            ...
            <div class="card-body">
                  ...
                  <div class="modal-content">
                      ...
                      <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-lg-6">
                              ...
                              <input id="mediNom" type="text" class="form-control" required="" placeholder="Medida de producto">
                            </div>
                        </div>
                      </div>
                    </div>
                   ...
                   <p id="error" style="color:#ff0000;text-align: center;"><?php echo (isset($respuesta))? $respuesta : " " ?></p>     
                    <div class="modal-footer">
                      <button id="closeRegis" type="reset" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
              ...
              <div class="modal fade" id="editarModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                <div class="modal-dialog modal-xm">
                  <div class="modal-content">
                    <div class="modal-header alert alert-success">
                      <h4 class="modal-title"><strong>Editar Medida de producto</strong></h4>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>

                    <div class="modal-body ">
                    <form class='editMedida'>
                    ...
                    <div class="form-group col-md-12">  
                      <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                              <label class="col-form-label"> <strong>Medida*</strong> </label>
                              <input id="medidaNomEdit"type="text" class="form-control" required="" >
  ...
  <?php $VarComp->js(); ?>
  <script src="assets/js/medida.js"></script> 
