...
<!-- ======= Sidebar ======= -->
  ...
  <main class="main" id="main">
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><h1> Productos Dañados</h1></li>
        </ol>
      </nav>
            ...
            <div class="card-body">
                ...
                <div class="modal-dialog modal-xm">
                  <div class="modal-content">
                    ...
                    <div class="modal-header alert alert-success">
                      <h4 class="modal-title"><strong>Registrar Productos Dañados</strong></h4>
                      ...
                      <div class="container-fluid">
                        <div class="row">
                            <div class="form-group col-lg-6">
                              <label class="col-form-label"> <strong>Producto dañado</strong> </label>
                              <input id="tipNom" type="text" class="form-control" required="" placeholder="producto dañado">
                            </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="modal fade" id="editarModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                <div class="modal-dialog modal-xm">
                  <div class="modal-content">
                    <div class="modal-header alert alert-success">
                      <h4 class="modal-title"><strong>Editar Producto Dañado</strong></h4>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
