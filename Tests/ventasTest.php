...
class ventasTest extends TestCase{
    ...
    public function testGetRegistrarVenta() {
      // Datos de prueba
      $cedula = 'V-30125380';
      ...
      $totalDolares = '0.53';
      $datosProducto = [
          ['producto' => '5', 'cantidad' => '5', 'precio' => '5']
      ];
      $datosTipoPago = [
          ['TipoPago' => '1', 'referencia' => '123123546', 'precioTipo' => '20.00']
      ];
  
      // Ejecutar el método a probar
      $result = $this->obj->getRegistrarVenta($cedula, $tipoCliente, $montoTotal, $totalDolares, $datosProducto, $datosTipoPago);
  
      $this->assertEquals('Se ha registrado la venta correctamente', $result['msg']);
  }
