...
if (isset($_POST['cod_productoEd'] , $_POST['tipoprodEd'] , $_POST['presentacionEd'] ,$_POST['laboratorioEd'] , $_POST['tipoEd'] , $_POST['claseEd'] , $_POST['composicionEd'] , $_POST['posologiaEd'] , $_POST['contraInEd'] , $_POST['id'], $permiso['Editar'])) {
    $respuesta = $objModel->getEditarProd($_POST['cod_productoEd'], $_POST['tipoprodEd'], $_POST['presentacionEd'], $_POST['laboratorioEd'], $_POST['tipoEd'], $_POST['claseEd'], $_POST['composicionEd'], $_POST['posologiaEd'], $_POST['contraInEd'], $_POST['id']);
    die(json_encode($respuesta));
}
