...
class menuLateral
{
  ...
  public function Menu()
  {
    ...
    $productosA = ($_GET['url'] == 'historialInventario' || $_GET['url'] == 'tipoProducto' || $_GET['url'] == 'medida' || $_GET['url'] == 'productoDanado' || $_GET['url'] == 'producto' || $_GET['url'] == 'laboratorio' || $_GET['url'] == 'proveedor' || $_GET['url'] == 'presentacion' || $_GET['url'] == 'clase' || $_GET['url'] == 'tipo' || $_GET['url'] == 'inventario') ? "" : "collapsed";
    $productosB = ($_GET['url'] == 'historialInventario' || $_GET['url'] == 'tipoProducto' || $_GET['url'] == 'medida' || $_GET['url'] == 'productoDanado' || $_GET['url'] == 'producto' || $_GET['url'] == 'laboratorio' || $_GET['url'] == 'proveedor' || $_GET['url'] == 'presentacion' || $_GET['url'] == 'clase' || $_GET['url'] == 'tipo' || $_GET['url'] == 'inventario') ? "show" : "collapse";
    ...
    $historialInventario = ($_GET['url'] == 'historialInventario') ? "active" : "";
    ...
    $productosNavLi = (isset($this->permisos['Historial de inventario']["Consultar"]) || isset($this->permisos['Inventario']["Consultar"]) || isset($this->permisos['Producto']["Consultar"]) || isset($this->permisos['Laboratorio']["Consultar"]) || isset($this->permisos['Proveedor']["Consultar"]) || isset($this->permisos['Clase']["Consultar"]) || isset($this->permisos['Tipo']["Consultar"]) || isset($this->permisos['Presentacion']["Consultar"]) || isset($this->permisos['Producto dañado']["Consultar"])) ?
      '<li class="nav-item">
