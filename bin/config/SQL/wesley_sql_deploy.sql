...
CREATE TABLE producto_sede (
    ...
    FOREIGN KEY (id_sede) REFERENCES sede (id_sede) ON DELETE CASCADE ON UPDATE CASCADE --   FOREIGN KEY (cod_producto) REFERENCES producto (cod_producto) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE venta_personal (
    id_venta int(11) AUTO_INCREMENT PRIMARY KEY,
    cedula varchar(15) NOT NULL,
    num_fact varchar(15) NOT NULL --   FOREIGN KEY (cedula) REFERENCES personal (cedula) ON DELETE CASCADE ON UPDATE CASCADE,
    --   FOREIGN KEY (num_fact) REFERENCES venta (num_fact) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
...
CREATE TABLE pagos_recibidos (
    ...
    num_fact varchar(15) NOT NULL,
    status tinyint(1) UNSIGNED NOT NULL --   FOREIGN KEY (num_fact) REFERENCES venta (num_fact) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
