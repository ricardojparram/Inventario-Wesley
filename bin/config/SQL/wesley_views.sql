...
SELECT ps.id_producto_sede, concat(tp.nombrepro,' ',pres.peso,' ',med.nombre,' ') AS presentacion_producto, tp.nombrepro as nombre_producto, pres.peso as presentacion_peso, med.nombre as medida, ps.lote, ps.fecha_vencimiento, ps.cantidad, s.nombre, tipo.nombre_t as tipo, clase.nombre_c as clase
