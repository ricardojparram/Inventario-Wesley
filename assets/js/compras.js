$(document).ready(function () {
  ...
  function validarValores() {
    $(".cantidad input").keyup(function () {
      validarCantidad($(this));
    });
    $(".precio input").keyup(function () {
      validarPrecio($(this));
    });
    $(".lote input").keyup(function () {
      validarLote($(this));
    });
  ...
  $("#proveedor").change(() => {
    validarSelect($("#proveedor"), $("#error1"), "Error de proveedor");
  });
  $("#orden").keyup(() => {
    validarNumero($("#orden"), $("#error2"), "Error de Orden,");
  });
  $("#fecha").change(() => {
    validarFecha($("#fecha"), $("#error3"), "Error de Fecha,");
  });

  $("#registrar").click((e) => {
    e.preventDefault();

    let proveedor = validarSelect(
      $("#proveedor"),
      $("#error1"),
      "Error de proveedor"
    );
